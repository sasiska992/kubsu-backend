                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="first_name" required 
                               value="<?= htmlspecialchars($edit_data['first_name']) ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>Фамилия:</label>
                        <input type="text" name="last_name" required 
                               value="<?= htmlspecialchars($edit_data['last_name']) ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>Отчество:</label>
                        <input type="text" name="patronymic" 
                               value="<?= htmlspecialchars($edit_data['patronymic']) ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="dob" required 
                               value="<?= htmlspecialchars($edit_data['dob']) ?>">
                    </div>
                    
                    <div class="form-group">
                        <label>Пол:</label>
                        <label><input type="radio" name="gender" value="male" 
                            <?= $edit_data['gender'] == 'male' ? 'checked' : '' ?>> Мужской</label>
                    ...
                    <?php foreach ($applications as $app): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="admin.php?delete=<?= $app['id'] ?>" class="btn btn-danger" 
